...
const Home = () => {
  ...
  const createProj = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/user/project/createproject", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
            ...
            {filteredData.length > 0 ? (
              ...
              <>
                <div className="flex flex-col justify-center items-center mt-7">
                  <img
                    src="https://media.tenor.com/q-i8fNYj6toAAAAM/spongebob-rainbow.gif" width="400px" height="400px"
                    alt="No projects"
                  />
                  <p className="mt-7 font-bold text-2xl" >No projects found</p>
                </div>
              </>
            )}
          </div>
